internal class Program
{
    private static void Main(string[] args)
    {
        ...
        */
        ...
        Array.Reverse(valueArray);
        string resultReverse = new string(valueArray);
        ...
        string openingDiv = "<div>";
        string closingDiv = "</div>";
        int openingDivPosition = input.IndexOf(openingDiv);
        int closingDivPosition = input.IndexOf(closingDiv);
        openingDivPosition += openingDiv.Length;
        int lengthDiv = closingDivPosition - openingDivPosition;
        string output = input.Substring(openingDivPosition, lengthDiv);
